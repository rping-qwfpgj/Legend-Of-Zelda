...
namespace HeadsUpDisplay
{
    public class Hud
    {
        ...
        {            
            ...
            throwableSprite = HudSpriteFactory.Instance.CreateSprite(new(x + 400, y + 62), "HudBoomerangSprite");
        ...
        public void Update()
        {
            ...
            blueMap.Update();
            float prevHeartCount = heartCount;
            heartCount = Link.Instance.health;
            mapCount = Link.Instance.inventory.getItemCount("orange map");
            switch (heartCount)
            {
                case 0:
                    sprites.Remove(heart1);
                    sprites.Remove(heart2);
                    sprites.Remove(heart3);
                    heart1 = pink1;
                    heart2 = pink2;
                    heart3 = pink3;
                    sprites.Add(heart1); 
