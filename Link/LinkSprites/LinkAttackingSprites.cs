...
namespace Sprites
{
    public class LinkAttackUpSprite : IAttackingSprite
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            this.destinationRectangle = new Rectangle((int)this.xPos, (int)this.yPos, 42, 42); // Where to draw on screen

            // Frame logic
            if(currFrames >= 0 && currFrames <= 500)
            {
                sourceRectangle = new Rectangle(1, 109, 16, 16);
                this.destinationRectangle = new Rectangle((int)this.xPos, (int)this.yPos, 42, 42);
            } else if (currFrames > 500 && currFrames <= 1000)
            {
                sourceRectangle = new Rectangle(18, 97, 16, 28);
                this.destinationRectangle = new Rectangle((int)this.xPos, (int)this.yPos - 48, 42, 74); // Y position is current rectangle height - inital rectangle's height
            } else if (currFrames > 1000 && currFrames <= 1500)
            {
                sourceRectangle = new Rectangle(37, 98, 12, 27);
                this.destinationRectangle = new Rectangle((int)this.xPos, (int)this.yPos - 44, 32, 72);
    ...
    public class LinkAttackDownSprite : IAttackingSprite
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (currFrames >= 0 && currFrames <= 500)
            {
                ...
                this.destinationRectangle = new Rectangle((int)this.xPos, (int)this.yPos, 42, 40); 
            }
            else if (currFrames > 500 && currFrames <= 1000)
            {
                sourceRectangle = new Rectangle(18, 47, 16, 27);
                this.destinationRectangle = new Rectangle((int)this.xPos, (int)this.yPos + 48, 42, 72); // Y position = yPos +(currRectangle height - originalRectangle height)
            }
            else if (currFrames > 1000 && currFrames <= 1500)
            {
                sourceRectangle = new Rectangle(35, 47, 15, 23);
                this.destinationRectangle = new Rectangle((int)this.xPos, (int)this.yPos + 32 , 40, 61);
            }
            else if (currFrames > 1500 && currFrames <= 2000)
            {
                sourceRectangle = new Rectangle(53, 47, 13, 19);
                this.destinationRectangle = new Rectangle((int)this.xPos, (int)this.yPos + 16, 34, 50); 
            }
    ...
    public class LinkAttackLeftSprite : IAttackingSprite
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            else if (currFrames > 500 && currFrames <= 1000)
            {
                ...
                this.destinationRectangle = new Rectangle((int)this.xPos - 48, (int)this.yPos, 72, 40); // xPos = xPos - (currRectangleWidth - originalRectangleWidth)
            }
            else if (currFrames > 1000 && currFrames <= 1500)
            {
                sourceRectangle = new Rectangle(46, 78, 23, 15);
                this.destinationRectangle = new Rectangle((int)this.xPos - 32, (int)this.yPos, 61, 40);
            }
            else if (currFrames > 1500 && currFrames <= 2000)
            {
                sourceRectangle = new Rectangle(70, 77, 19, 16);
                this.destinationRectangle = new Rectangle((int)this.xPos - 16, (int)this.yPos, 50, 42); 
            }
    ...
    public class LinkAttackRightSprite : IAttackingSprite
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            {
                sourceRectangle = new Rectangle(-1, 78, 15, 15);
                destinationRectangle = new Rectangle((int)this.xPos, (int)this.yPos, 40, 40); 
            }
            else if (currFrames > 500 && currFrames <= 1000)
            {
                sourceRectangle = new Rectangle(18, 78, 27, 15);
                destinationRectangle = new Rectangle((int)this.xPos + 48, (int)this.yPos, 72, 40);  // xPos = xPos + (currRectangleWidth - originalRectangleWidth)
            }
            else if (currFrames > 1000 && currFrames <= 1500)
            {
                sourceRectangle = new Rectangle(46, 78, 23, 15);
                destinationRectangle = new Rectangle((int)this.xPos + 32, (int)this.yPos, 61, 40);
            }
            else if (currFrames > 1500 && currFrames <= 2000)
            {
                sourceRectangle = new Rectangle(70, 77, 19, 16);
                destinationRectangle = new Rectangle((int)this.xPos + 16, (int)this.yPos, 50, 42);
            }
