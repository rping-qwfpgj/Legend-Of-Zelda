...
namespace Sprites
{
    public class LinkThrowingUpSprite : IAttackingSprite
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            this.destinationRectangle = new Rectangle((int)this.xPosition, (int)this.yPosition, 42, 42); // Where to draw on screen
    ...
    public class LinkThrowingDownSprite : IAttackingSprite
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            Rectangle sourceRectangle = new Rectangle(); // Store the current location on the spritesheet to get a sprite from
            this.destinationRectangle = new Rectangle((int)this.xPosition, (int)this.yPosition, 42, 40); // Where to draw on screen
